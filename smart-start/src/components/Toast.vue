<template>
    <div v-show="displayed" class="inset-x-0 mx-auto absolute top-0 flex justify-center text-sm">
        <div class="flex items-center w-full max-w-md p-2 mt-4 rounded-lg shadow mx-2" :class="[background, text]">
